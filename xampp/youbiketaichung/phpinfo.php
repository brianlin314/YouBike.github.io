...
$sql = "SELECT name_tw,area_code,district_tw,address_tw,available_spaces,empty_spaces,lat,lng FROM taichung ";
...
<body>
    ...
    <li>
      <img src="https://www.youbike.com.tw/region/assets/images/1.0-map-red.svg" alt="" class="img-fluid" width="28"> 車輛數 <= 10
    </li>
    <li>
      <img src="https://www.youbike.com.tw/region/assets/images/1.0-map-orange.svg" alt="" class="img-fluid" width="28"> 車輛數 <= 3
    </li>
  </ul>
<div id="map"></div>
<script>
...
sectors[1]=['西屯區', '西區', '南區', '大里區', '東區', '北區', '北屯區', '南屯區', '潭子區', '太平區', '中區', '烏日區'];	
