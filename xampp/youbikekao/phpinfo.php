...
$sql = "SELECT name_tw,area_code,district_tw,address_tw,available_spaces,empty_spaces,lat,lng FROM kao ";
...
<body>
    ...
    <div class="board-head pb-3">
      <div class="px-3 pt-3 mb-2 d-flex justify-content-between">
        ...
        <input type="button" value="回首頁" name="按鈕名稱" onclick="self.location.href='http://localhost/mainpage/index.html'"/>
    ...
    <ul id="legend">
    <li>
      <img src="https://www.youbike.com.tw/region/assets/images/1.0-map-green.svg" alt="" class="img-fluid" width="28"> 車輛數 > 10
    </li>
    <li>
      <img src="https://www.youbike.com.tw/region/assets/images/1.0-map-orange.svg" alt="" class="img-fluid" width="28"> 車輛數 <= 10
    </li>
    <li>
      <img src="https://www.youbike.com.tw/region/assets/images/1.0-map-red.svg" alt="" class="img-fluid" width="28"> 車輛數 <= 3
    </li>
  </ul>
<div id="map"></div>
<script>
...
var nospace = new L.Icon({
  iconUrl: 'https://www.youbike.com.tw/region/assets/images/1.0-map-orange.svg',
...
var nobike = new L.Icon({
  iconUrl: 'https://www.youbike.com.tw/region/assets/images/1.0-map-red.svg',
  shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
  iconSize: [30, 46],
  iconAnchor: [12, 41],
  popupAnchor: [1, -34],
...
var work = new L.Icon({
  iconUrl: 'https://www.youbike.com.tw/region/assets/images/1.0-map-green.svg',
  shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
  iconSize: [30, 46],
  iconAnchor: [12, 41],
  popupAnchor: [1, -34],
...
sectors[1]=['小港區', '鹽埕區', '大寮區', '鳳山區', '左營區', '楠梓區', '苓雅區', '路竹區', '前鎮區', '阿蓮區', '仁武區', '橋頭區', '鼓山區', '旗山區', '燕巢區', '梓官區', '三民區', '岡山區', '大社區', '鳥松區', '旗津區', '大樹區', '美濃區', '林園區', '湖內區','彌陀區', '茄萣區', '前金區', '新興區', '永安區'];
...
function getUserPosition() {
  if(navigator.geolocation) {
    function showPosition(position) {
      L.marker([position.coords.latitude, position.coords.longitude], {iconUrl: 'https://chiayi.youbike.com.tw/photos/map/2.0_icon_full.png'}).addTo(map);
