...
$sql = "SELECT name_tw,area_code,district_tw,address_tw,available_spaces,empty_spaces,lat,lng FROM chiayi ";
    ...
    <div class="board-head pb-3">
      <div class="px-3 pt-3 mb-2 d-flex justify-content-between">
        <h1 class="mb-0 h3 font-weight-bold">YouBike2.0實時地圖</h1>
         ...
         <input type="button" value="預測地圖" name="按鈕名稱" onclick="self.location.href='http://localhost/xampp/test/phpinfo.php'"/>
