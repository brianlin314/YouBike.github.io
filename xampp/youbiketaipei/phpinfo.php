...
$sql = "SELECT name_tw,area_code,district_tw,address_tw,available_spaces,empty_spaces,lat,lng FROM taipei ";
...
<body>
    ...
    <li>
      <img src="https://www.youbike.com.tw/region/assets/images/1.0-map-orange.svg
" alt="" class="img-fluid" width="28"> 車輛數 <= 10
    </li>
    <li>
...
sectors[1]=['中正區', '大安區', '士林區', '內湖區', '信義區', '北投區', '文山區', '萬華區', '大同區', '中山區', '臺大專區'];
